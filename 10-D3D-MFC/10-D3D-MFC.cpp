...
// 10-D3D-MFC.cpp: 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CMy10D3DMFCApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMy10D3DMFCApp::OnAppAbout)
